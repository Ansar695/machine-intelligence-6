...
const mission = {
  ...
  vision: "To be the leading software development partner that transforms ideas into powerful digital experiences.",
  values: [
    {
      icon: Heart,
    ...
    },
    {
      ...
      description: "We maintain the highest standards of code quality and security in everything we build."
    }
  ]
}
...
const timeline = [
  {
    ...
    description: "Started as a small team with a vision to create exceptional software solutions for growing businesses.",
    milestone: "Founded"
  },
  {
    year: "2020",
    title: "First Major Client",
    description: "Landed our first enterprise client and delivered a scalable e-commerce platform that increased their revenue by 300%.",
    milestone: "Growth"
  },
  {
    year: "2021",
    title: "Team Expansion",
    description: "Grew our team to 15+ experienced developers and designers, enabling us to take on larger, more complex projects.",
    milestone: "Scale"
  },
  {
    year: "2022",
    title: "International Reach",
    description: "Expanded our client base globally, working with companies across North America, Europe, and Asia.",
    milestone: "Global"
  },
  {
    year: "2023",
    title: "Technology Leadership",
    description: "Became early adopters of AI/ML integration in software development, helping clients leverage cutting-edge technology.",
    milestone: "Innovation"
  },
  {
    year: "2024",
    title: "Award Recognition", 
    description: "Received multiple industry awards for excellence in software development and client satisfaction.",
    milestone: "Recognition"
  },
  {
    year: "2025",
    title: "Future Vision",
    description: "Continuing to innovate and expand our services to help more businesses succeed in the digital economy.",
    milestone: "Future"
  }
]
...
const certifications = [
  {
    ...
    year: "2024",
    description: "Recognized expertise in cloud architecture and migration services",
    icon: Award
  },
  {
  ...
  },
  {
    ...
    issuer: "Microsoft",
    year: "2023",
    description: "Highest level of Microsoft partnership for Azure and development services",
    icon: Star
  },
  {
  ...
  },
  {
    ...
    issuer: "AICPA",
    year: "2024",
    description: "Security, availability, and confidentiality compliance certification",
    icon: CheckCircle
  }
]
...
const culture = [
  {
    ...
    description: "We embrace flexible working arrangements that prioritize work-life balance and productivity.",
    icon: Globe
  },
  {
    title: "Continuous Learning",
    description: "Investment in team growth through training, conferences, and certification programs.",
    icon: Lightbulb
  },
  {
    title: "Innovation Time",
    description: "20% time dedicated to exploring new technologies and contributing to open-source projects.",
    icon: Zap
  },
  {
    title: "Diverse & Inclusive",
    description: "Building a team that represents diverse backgrounds, perspectives, and experiences.",
    icon: Users
  }
]
  ...
  return (
    <>
      <SEO 
        ...
        description="Learn about SoftwareCraft's mission to empower businesses with innovative software solutions. Meet our team of expert developers and discover our journey since 2019."
        keywords="software development company, about us, company mission, expert developers, innovation, software team"
        ogTitle="About SoftwareCraft - Expert Software Development Team"
        ogDescription="Founded in 2019, we've helped 150+ companies transform their business with custom software solutions. Meet the team behind the innovation."
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              We're a passionate team of developers, designers, and strategists dedicated to building 
              software solutions that transform businesses and create lasting impact.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" variant="outline">
                <Link href="/careers" data-testid="hero-cta-secondary">
                  Join Our Team
                </Link>
              </Button>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Six years of consistent growth and success, powered by our amazing team and clients.
            </p>
          </div>
            ...
            {team.map((member, index) => (
              <Card key={index} className="text-center hover-elevate">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-lg font-semibold mb-1" data-testid={`team-name-${index}`}>
                    {member.name}
                  </h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="text-lg font-semibold text-card-foreground" data-testid={`cert-title-${index}`}>
                          {cert.title}
                        </h3>
              ...
              <Card key={index} className="hover-elevate">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold mb-2" data-testid={`culture-title-${index}`}>
                        {item.title}
                      </h3>
                      <p className="text-muted-foreground leading-relaxed">
                        {item.description}
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-primary/10 via-chart-2/10 to-primary/10 rounded-2xl p-8 md:p-12 text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Whether you're looking for a development partner or want to join our team, 
              we'd love to hear from you.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-gradient-to-r from-primary to-chart-2">
                <Link href="/contact" data-testid="final-cta-client">
                  Start Your Project
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link href="/careers" data-testid="final-cta-careers">
                  Explore Careers
                </Link>
              </Button>
            </div>
