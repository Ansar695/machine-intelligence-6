...
function ServicesContent() {
  ...
  const [selectedTechCategory, setSelectedTechCategory] = useState<keyof typeof techStack>('frontend')
              ...
              <Card key={index} className="group hover-elevate h-full">
                ...
                <CardContent className="space-y-6">
                  ...
                  <Button asChild className="w-full" variant="outline">
                    <Link href="/contact" data-testid={`service-cta-${index}`}>
                      Get Started
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Link>
                  </Button>
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-8">
              {Object.keys(techStack).map((category) => (
                <Button
                  ...
                  onClick={() => setSelectedTechCategory(category as keyof typeof techStack)}
