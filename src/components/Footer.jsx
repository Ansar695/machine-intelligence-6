        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md leading-relaxed">
              We transform ideas into powerful software solutions that drive business growth. 
                ...
                <a
                  ...
                  data-testid={`footer-contact-${link.name.toLowerCase()}`}>
                      ...
                      <span className="text-sm">
                        {link.name === 'Email' ? 'hello@softwarecraft.com' :
                    link.name === 'Phone' ? '+1 (555) 123-4567' : link.name}
                      </span>
                    </a>
                }
                </div>
